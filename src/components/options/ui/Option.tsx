...
const Option: React.FC<OptionProps> = ({ title, children }) => {
    return (
        <div className="w-full flex justify-between items-center p-3 mb-3 dark:bg-[#1a1a1a] bg-zinc-100 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200">
